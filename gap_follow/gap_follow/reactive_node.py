...
class ReactiveFollowGap(Node):
    ...
    def __init__(self):
        ...
        self.smooth_window = 7 #oving average window (odd)

        # (2) Use only front field-of-view
        self.fov_deg = 140      # front FOV

        # (3) Gap logic
        self.min_gap_dist = 0.45       # free-space threshold
        self.bubble_radius = 0.85      # safety bubble around closest obstacle (m)
        ...
        self.edge_margin_m = 0.30 # trim risky gap edges (meters)
        self.cap_close_1 = 0.45        # if closest < this -> strong cap
        self.cap_close_2 = 0.70
     # if closest < this -> mid cap
        self.cap_speed_1 = 2.8        # strong cap speed
        self.cap_speed_2 = 4.      # mid cap speed
